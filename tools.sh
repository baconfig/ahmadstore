...
mkdir -p /var/lib/ahmadstore >/dev/null 2>&1
echo "IP=" >> /var/lib/ahmadstore/ipvps.conf
...
mkdir -p /etc/ahmadstore
mkdir -p /etc/ahmadstore/limit
mkdir -p /etc/ahmadstore/limit/trojan
mkdir -p /etc/ahmadstore/limit/vless
mkdir -p /etc/ahmadstore/limit/vmess
mkdir -p /etc/ahmadstore/limit/shadowsocks
mkdir -p /etc/ahmadstore/limit/ssh
mkdir -p /etc/ahmadstore/limit/ssh/ip
mkdir -p /etc/ahmadstore/limit/trojan/ip
mkdir -p /etc/ahmadstore/limit/trojan/quota
mkdir -p /etc/ahmadstore/limit/vless/ip
mkdir -p /etc/ahmadstore/limit/vless/quota
mkdir -p /etc/ahmadstore/limit/vmess/ip
mkdir -p /etc/ahmadstore/limit/vmess/quota
mkdir -p /etc/ahmadstore/limit/shadowsocks/ip
mkdir -p /etc/ahmadstore/limit/shadowsocks/quota
mkdir -p /etc/ahmadstore/trojan
mkdir -p /etc/ahmadstore/vless
mkdir -p /etc/ahmadstore/vmess
mkdir -p /etc/ahmadstore/shadowsocks
mkdir -p /etc/ahmadstore/log
mkdir -p /etc/ahmadstore/log/trojan
mkdir -p /etc/ahmadstore/log/vless
mkdir -p /etc/ahmadstore/log/vmess
mkdir -p /etc/ahmadstore/log/shadowsocks
mkdir -p /etc/ahmadstore/log/ssh
mkdir -p /etc/ahmadstore/cache

mkdir -p /etc/ahmadstore/cache/trojan-tcp

mkdir -p /etc/ahmadstore/cache/trojan-ws
mkdir -p /etc/ahmadstore/cache/trojan-grpc
mkdir -p /etc/ahmadstore/cache/shadowsocks-ws
mkdir -p /etc/ahmadstore/cache/shadowsocks-grpc
mkdir -p /etc/ahmadstore/cache/vless-ws
mkdir -p /etc/ahmadstore/cache/vless-grpc
mkdir -p /etc/ahmadstore/cache/vmess-ws
mkdir -p /etc/ahmadstore/cache/vmess-grpc
mkdir -p /etc/ahmadstore/cache/vmess-ws-orbit
mkdir -p /etc/ahmadstore/cache/vmess-ws-orbit1
}

function fixtema(){
rm -rf /etc/ahmadstore/theme > /dev/null 2>&1
...
<font color="red"><b>********  Ahmad Store  ********</b></font><br>
<font color="blue"><b>===============================</br></font><br>
END
}
function sendtele(){
wget https://raw.githubusercontent.com/Rerechan02/v/main/api
sed -i "s/Rerechan02/ahmadstore/g" /root/api
